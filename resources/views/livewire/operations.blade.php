                            ...
                            @if ($operations->count() > 0)
                                @foreach ($operations as $operation)
                                    <tr>
                                        ...
                                        <td>
                                            <button wire:click="confirmOperationEdit( {{$operation->id}} )" wire:loading.attr="disabled">
                                        ...
                                        <td>
                                            <a wire:click="confirmOperationDeletion( {{$operation->id}})" wire:loading.attr="disabled">
