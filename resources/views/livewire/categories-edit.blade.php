<div id="updateCategoryModal">
    <form class="max-w-md mx-auto" wire:submit.prevent="categoryEdit">
        <div>
            <label for="small-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Categoria</label>
            <input type="text" id="name" name="name" wire:model="name" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
    
        <label for="Color" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Cor</label>
        ...
        <button type="button" wire:click="categoryEdit({{$category}})" class="btn btn-info">Atualizar</button>
