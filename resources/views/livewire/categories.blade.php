        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <h2 class="font-semibold fs-1 text-xl text-gray-800 leading-tight flex justify-between">
                    {{ __('Categorias') }} #{{$categories->count()}}
                    <div class="mr-2">
                                ...
                                @foreach ($categories as $category)
                                    <tr style="text-align: center;">
                                        ...
                                        <td style="background: {{$category->color}}; border: none;">
                                            <button wire:click="confirmCategoryEdit( {{ $category->id}})" wire:loading.attr="disabled" title="Editar">
                                        ...
                                        <td style="background: {{$category->color}}; border: none;">
                                            <button wire:click="confirmCategoryDeletion( {{ $category->id}})" wire:loading.attr="disabled" title="Deletar">
