                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>    
                                        ...
                                        <td>
                                            <button wire:click="confirmUserDeletion( {{ $user->id}})" wire:loading.attr="disabled" wire:confirm="Você tem certeza que deseja deletar esse Usuário?" title="Deletar">
